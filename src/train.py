...
def train(data_path, model_path, random_state, n_estimators):
    ...
    with mlflow.start_run():
        ...
        mlflow.log_param("min_sample_split", grid_search.best_params_['min_samples_split'])
...
if __name__ == "__main__":
    train(params["data"], params["model"], params["random_state"], params["n_estimators"])